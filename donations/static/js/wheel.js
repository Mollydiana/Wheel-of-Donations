...
$(document).ready(function() {
    ...
    venues = {
        ...
        "SaveChildren": "www.savethechildren.org",
        "Change": "www.change.org",
        "Reftrans": "www.reftrans.org",
        "Unicef": "www.unicef.org",
        "ASPCA": "www.aspca.org",
        "ChildAid": "www.queremosgalego.org",
        "PlannedParenthood": "www.plannedparenthood.org",
        "wwlf": "www.worldwildlife.org",
        "Sierra": "www.sierraclub.org",
        "End Homelessness": "www.endhomelessness.org",
        "Catholic Relief Services": "www.crs.org",
        "Fistula": "www.fistulafoundation.org",
        "vday": "www.vday.org",
        "rescue": "www.rescue.org",
        "endgenocide": "www.endgenocide.org"
    };
    ...
    var wheel = {
        ...
        canvasContext: null,
        colors: ['#FF434C' , '#6A6EEB', '#00cc45', '#00a9ff', '#2ef2bf', '#bf2ef2',
                 '#3232F2', '#FF001C', '#fffd1a', '#66e6ff', '#00E0FF', '#19FF60'],
    ...
    /*
        ...
        initAudio2: function() {
            ...
            sound2.setAttribute('src', 'http://bramp.net/javascript/wheel.mp3');
        ...
        drawNeedle: function() {
            ...
            ctx.font = "2em Arial";
            currentCharity = wheel.segments[i];
            console.log(currentCharity);
            $("a#currentCharityLink").attr('href', "http://" + currentCharity);
            $("a#currentCharityLink").text(currentCharity);
